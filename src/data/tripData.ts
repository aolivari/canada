...
export const days: Day[] = [
  // ── DÍA 1: VUELO ──
  {
    ...
    activities: [
      ...
      { time: "17:30", title: "🚗 Road trip a Sarnia (~3h)", description: "Coger la 401 hacia el oeste. Llegada sobre las 20:30-21:00", icon: "🚗" },
      { time: "~20:30", title: "🏠 Llegada a casa del primo en Sarnia", description: "Cena familiar. Días de relax en el lago Hurón", icon: "🏠", isHighlight: true, location: { name: "Sarnia", address: "Sarnia, ON, Canadá", mapsUrl: "https://www.google.com/maps?q=Sarnia+Ontario" } },
    ],
  },
  // ── DÍA 2-6: SARNIA ──
  {
    ...
    subtitle: "5 días en familia. Lago Hurón, barbacoas 🎉",
    activities: [
      { time: "22 ago", title: "🥞 Desayuno + día de playa", description: "Canatara Park, Lago Hurón. Sin prisas", icon: "🌊", isHighlight: true, location: { name: "Canatara Park", address: "1200 Lake Chipico Dr, Sarnia, ON N7S 6K7", mapsUrl: "https://www.google.com/maps?q=Canatara+Park+Sarnia" } },
      { time: "23 ago", title: "Día en familia", description: "Barbacoa, paseo, lo que surja", icon: "🏠" },
      { time: "24 ago", title: "Excursión Point Pelee", description: "El punto más sur de Canadá mainland (o día libre)", icon: "🌲", location: { name: "Point Pelee National Park", address: "1118 Point Pelee Dr, Leamington, ON N8H 3V4", mapsUrl: "https://www.google.com/maps?q=Point+Pelee+National+Park" } },
      { time: "25 ago", title: "Día libre", description: "Playa, senderos, relax total", icon: "☀️" },
      { time: "26 ago", title: "Último día en Sarnia", description: "Preparar maletas para Niagara Falls mañana", icon: "🧳" },
    ],
  },
